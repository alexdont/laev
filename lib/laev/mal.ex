defmodule Laev.MAL do
  ...
  `laev mal login`, and the tokens live in `~/.laev/mal.json`, auto-refreshed.
  ...
  def client_id, do: Application.get_env(:laev_app, :mal_client_id)
  def client_secret, do: Application.get_env(:laev_app, :mal_client_secret)
  ...
  defp handle_conn(conn, expected_state) do
    ...
    body =
      case result do
        {:ok, _} -> "<h2>Laev is linked to MyAnimeList ✓</h2><p>You can close this tab and return to the terminal.</p>"
